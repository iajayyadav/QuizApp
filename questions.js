const MASTER_BANK = [
    ...
    { q: "LibreOffice Draw की फाइल एक्सटेंशन क्या है?", options: [".svg", ".odg", ".png", ".drw"], answer: 1, topic: 'Draw' },
    { q: "LibreOffice Base की फाइल एक्सटेंशन क्या है?", options: [".mdb", ".sql", ".odb", ".dbf"], answer: 2, topic: 'Base' },
    ...
    { q: "Undo का शॉर्टकट क्या है?", options: ["Ctrl+Z", "Ctrl+Y", "Ctrl+U", "Ctrl+X"], answer: 0, topic: 'Shortcuts' },
    { q: "Redo का शॉर्टकट क्या है?", options: ["Ctrl+Y", "Ctrl+Z", "Ctrl+R", "Ctrl+T"], answer: 0, topic: 'Shortcuts' },
    { q: "Print का शॉर्टकट क्या है?", options: ["Ctrl+P", "Ctrl+S", "Ctrl+O", "Ctrl+N"], answer: 0, topic: 'Shortcuts' },
    { q: "LibreOffice Writer में 'Find and Replace' का शॉर्टकट क्या है?", options: ["Ctrl+H", "Ctrl+F", "Ctrl+R", "Ctrl+G"], answer: 0, topic: 'Writer' },
    { q: "LibreOffice Writer में Spell Check का शॉर्टकट क्या है?", options: ["F7", "F5", "F1", "F12"], answer: 0, topic: 'Writer' },
    { q: "LibreOffice Writer में Header/Footer किस मेनू में होता है?", options: ["Insert", "Format", "View", "File"], answer: 0, topic: 'Writer' },
    { q: "LibreOffice Calc में न्यूनतम मान (Minimum) के लिए कौन सा फ़ंक्शन है?", options: ["=MIN(...)", "=MAX(...)", "=LOW(...)", "=LEAST(...)"], answer: 0, topic: 'Calc' },
    { q: "LibreOffice Calc में अधिकतम मान (Maximum) के लिए कौन सा फ़ंक्शन है?", options: ["=MAX(...)", "=MIN(...)", "=HIGH(...)", "=TOP(...)"], answer: 0, topic: 'Calc' },
    { q: "LibreOffice Calc में 'Merge Cells' का क्या कार्य है?", options: ["दो या अधिक सेलों को एक सेल में मिलाना", "सेलों को विभाजित करना", "सेलों को छुपाना", "सेलों को रंगना"], answer: 0, topic: 'Calc' },
    { q: "LibreOffice Impress में Slide Show शुरू करने का शॉर्टकट क्या है?", options: ["F5", "F7", "Ctrl+P", "Shift+F5"], answer: 0, topic: 'Impress' },
    { q: "LibreOffice Impress में Slide Master का क्या उपयोग है?", options: ["सभी स्लाइड्स को एक जैसा डिजाईन देना", "नई स्लाइड जोड़ना", "स्लाइड डिलीट करना", "एनीमेशन लगाना"], answer: 0, topic: 'Impress' },
    { q: "LAN का पूरा नाम क्या है?", options: ["Local Area Network", "Large Area Network", "Logical Area Network", "Link Area Network"], answer: 0, topic: 'Network' },
    { q: "WAN का पूरा नाम क्या है?", options: ["Wide Area Network", "Web Area Network", "Wired Area Network", "Wireless Area Network"], answer: 0, topic: 'Network' },
    { q: "ISP का पूरा नाम क्या है?", options: ["Internet Service Provider", "Internal Service Provider", "Internet System Protocol", "Internet Service Protocol"], answer: 0, topic: 'Internet' },
    { q: "Trojan क्या है?", options: ["एक प्रकार का मैलवेयर जो उपयोगी लगता है", "एक एंटीवायरस", "एक हार्डवेयर डिवाइस", "एक ब्राउज़र"], answer: 0, topic: 'Security' },
    { q: "VPN का पूरा नाम क्या है?", options: ["Virtual Private Network", "Virtual Public Network", "Verified Private Network", "Very Private Network"], answer: 0, topic: 'Security' },
    { q: "Encryption का क्या अर्थ है?", options: ["डेटा को सीक्रेट कोड में बदलना", "डेटा को डिलीट करना", "डेटा को कॉपी करना", "डेटा को भेजना"], answer: 0, topic: 'Security' },
    { q: "AEPS का पूरा नाम क्या है?", options: ["Aadhaar Enabled Payment System", "Aadhaar Electronic Payment System", "All Electronic Payment System", "Aadhaar Easy Payment System"], answer: 0, topic: 'Payments' },
    { q: "USSD का पूरा नाम क्या है?", options: ["Unstructured Supplementary Service Data", "Unified Supplementary Service Data", "Universal Service Data", "United Service Data"], answer: 0, topic: 'Payments' },
    { q: "QR Code का पूरा नाम क्या है?", options: ["Quick Response Code", "Quick Read Code", "Quality Response Code", "Query Response Code"], answer: 0, topic: 'Payments' },
    { q: "UMANG App का उद्देश्य क्या है?", options: ["सरकारी सेवाओं तक एक ही जगह पहुंच", "ऑनलाइन शॉपिंग", "गेम खेलना", "वीडियो देखना"], answer: 0, topic: 'Govt' },
    { q: "DigiLocker का उपयोग किस लिए होता है?", options: ["डिजिटल दस्तावेज़ स्टोर करने के लिए", "ईमेल भेजने के लिए", "फंड ट्रांसफर करने के लिए", "प्रेजेंटेशन बनाने के लिए"], answer:0, topic: 'Govt' },
    { q: "IoT का पूरा नाम क्या है?", options: ["Internet of Things", "Internet of Technology", "Internal of Things", "Internet of Transfer"], answer: 0, topic: 'Future' },
    { q: "AI का पूरा नाम क्या है?", options: ["Artificial Intelligence", "Automated Intelligence", "Advanced Intelligence", "Artistic Intelligence"], answer: 0, topic: 'Future' },
    { q: "इनमें से कौन सा एक Input Device है?", options: ["Keyboard", "Monitor", "Printer", "Speaker"], answer: 0, topic: 'Fundamentals' },
    { q: "इनमें से कौन सा एक Output Device है?", options: ["Monitor", "Mouse", "Scanner", "Microphone"], answer: 0, topic: 'Fundamentals' },
    { q: "कंप्यूटर की पहली पीढ़ी (First Generation) में किसका उपयोग किया गया था?", options: ["Vacuum Tubes", "Transistors", "Integrated Circuits", "Microprocessors"], answer: 0, topic: 'Fundamentals' },
    { q: "कंप्यूटर माउस का आविष्कार किसने किया?", options: ["Douglas Engelbart", "Charles Babbage", "Bill Gates", "Tim Berners-Lee"], answer: 0, topic: 'Fundamentals' },
    { q: "ईमेल भेजते समय 'To' फील्ड का क्या उपयोग है?", options: ["मुख्य प्राप्तकर्ता का ईमेल पता", "गुप्त प्राप्तकर्ता का ईमेल पता", "विषय लिखने के लिए", "फाइल अटैच करने के लिए"], answer: 0, topic: 'Email' },
    { q: "LibreOffice में 'Save As' का शॉर्टकट क्या है?", options: ["Ctrl+Shift+S", "Ctrl+S", "Ctrl+A", "Alt+S"], answer: 0, topic: 'Shortcuts' }
];
